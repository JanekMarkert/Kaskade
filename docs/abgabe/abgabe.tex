...
32{,}33~m fast 100-mal so groß. Der Großteil der Fixes sitzt also sehr
...
Zwei Befunde stechen heraus. Erstens: BLE-RSSI degradiert mit wachsender
Distanz deutlich und systematisch -- der Fehler wächst ab~5~m stark und
erreicht bei 8--9~m fast 4{,}7--4{,}8~m, bei durchweg negativer Verzerrung
(die App unterschätzt die Distanz). Das entspricht dem erwarteten Verhalten
signalstärkebasierter Verfahren und bestätigt UWB als das für diesen
Anwendungsfall deutlich robustere Verfahren über die getestete Distanz.
Zweitens: die 9-m-Messung war praktisch nicht durchführbar -- das
UWB-Ranging brach bei dieser Distanz zuverlässig ab, weshalb für 9~m nur
BLE-Werte vorliegen. 8~m ist damit die erreichte Obergrenze der
Messreihe, und schon dort zeigt UWB einen deutlich erhöhten Fehler
gegenüber den Nachbardistanzen (1{,}08--1{,}20~m statt 0{,}2--0{,}4~m bei
2--7~m) -- ein Hinweis auf eine praktische Reichweitengrenze unterhalb der
...
der Literatur erwartete Rangfolge: UWB bleibt über die getestete Distanz
mit einem MAE von durchweg unter 0{,}4~m stabil, BLE-RSSI degradiert ab
